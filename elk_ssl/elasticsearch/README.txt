...
1. This README file
2. http-elasticsearch.csr
3. http-elasticsearch.key
4. sample-elasticsearch.yml

## http-elasticsearch.csr

The "http-elasticsearch.csr" file is a Certificate Signing Request.
...
In either case, you need to provide the http-elasticsearch.csr file to the certificate authority, and they will provide you with your signed certificate.
For the purposes of this document, we assume that when they send you your certificate, you will save it as a file named "http-elasticsearch.crt".
...
The "http-elasticsearch.key" file is your private key.
...
certificate. When you have a copy of the certificate you should copy it and the private key ("http-elasticsearch.key") to the config directory.
The sample config assumes that the certificate is named "http-elasticsearch.crt".
